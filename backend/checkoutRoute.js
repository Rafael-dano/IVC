...
const ANNUAL_PROMO_PRICE_BY_CODE = {
  ANNUAL_99:
    process.env.STRIPE_PRICE_ANNUAL_PROMO_99 ||
    process.env.STRIPE_PRICE_ANNUAL_99 ||
    process.env.STRIPE_PRICE_LTD99,
    ANNUAL_149:
    process.env.STRIPE_PRICE_ANNUAL_PROMO_149 ||
    process.env.STRIPE_PRICE_ANNUAL_149 ||
    process.env.STRIPE_PRICE_LTD149,
};
