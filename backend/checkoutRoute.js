...
const ANNUAL_PROMO_PRICE_BY_CODE = {
  STRIPE_PRICE_LTD99: process.env.STRIPE_PRICE_ANNUAL_PROMO_99 || process.env.STRIPE_PRICE_LTD99,
  STRIPE_PRICE_LTD149: process.env.STRIPE_PRICE_ANNUAL_PROMO_149 || process.env.STRIPE_PRICE_LTD149,
};
