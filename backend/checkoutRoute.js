...
const LIFETIME_99_PRICE = process.env.STRIPE_PRICE_LIFETIME_99 || process.env.STRIPE_PRICE_LTD99;
const LIFETIME_149_PRICE = process.env.STRIPE_PRICE_LIFETIME_149 || process.env.STRIPE_PRICE_LTD149;
const LIFETIME_400_PRICE = process.env.STRIPE_PRICE_LIFETIME_400 || process.env.STRIPE_PRICE_LTD400;
const LTD_PRICE_BY_TIER = {
  LTD_99: LIFETIME_99_PRICE,
  LTD_149: LIFETIME_149_PRICE,
